<br>
    ...
    <!-- Page level plugins -->
    <script src="/~team4/my/admin/vendor/chart.js/Chart.min.js"></script>

    <!-- Page level custom scripts -->
    <script src="/~team4/my/admin/js/demo/chart-area-demo.js"></script>
    <script src="/~team4/my/admin/js/demo/chart-pie-demo.js"></script>
